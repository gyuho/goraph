...
func TestDijkstra05(t *testing.T) {
	...
	if mapToDistance[data.GetNodeByID("E")] != 20.0 {
		t.Errorf("Expected 20.0 but %f", mapToDistance[data.GetNodeByID("E")])
	}
}
...
func TestDijkstra10(t *testing.T) {
	...
	if mapToDistance[data.GetNodeByID("E")] != 36.0 {
		t.Errorf("Expected 36.0 but %f", mapToDistance[data.GetNodeByID("E")])
	}
}
...
func TestDijkstra10Reverse(t *testing.T) {
	...
	pathSlice, mapToDistance := data.Dijkstra(data.GetNodeByID("E"), data.GetNodeByID("A"))
	ts := []string{}
	for _, v := range pathSlice {
		ts = append(ts, fmt.Sprintf("%s(%.2f)", v.ID, mapToDistance[v]))
	}
	...
	if mapToDistance[data.GetNodeByID("A")] != 22.0 {
		t.Errorf("Expected 22.0 but %f", mapToDistance[data.GetNodeByID("A")])
	}
}
...
func TestDijkstra11(t *testing.T) {
	...
	if mapToDistance[data.GetNodeByID("T")] != 68.0 {
		t.Errorf("Expected 68.0 but %f", mapToDistance[data.GetNodeByID("T")])
	}
}
...
func TestDijkstra11Reverse(t *testing.T) {
	...
	pathSlice, mapToDistance := data.Dijkstra(data.GetNodeByID("T"), data.GetNodeByID("S"))
	ts := []string{}
	for _, v := range pathSlice {
		ts = append(ts, fmt.Sprintf("%s(%.2f)", v.ID, mapToDistance[v]))
	}
	...
	if mapToDistance[data.GetNodeByID("S")] != 48.0 {
		t.Errorf("Expected 48.0 but %f", mapToDistance[data.GetNodeByID("S")])
	}
}
