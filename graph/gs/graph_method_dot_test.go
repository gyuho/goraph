...
func Test_DOT_GetVerticesSize(t *testing.T) {
	g := FromDOT("../../files/testgraph.001.dot")
	r := g.GetVerticesSize()
	if r != 8 {
...
func Test_DOT_GetEdges(t *testing.T) {
	g := FromDOT("../../files/testgraph.001.dot")
	l := g.GetEdgesSize()
...
func Test_DOT_GetEdgesSize(t *testing.T) {
	g1 := FromDOT("../../files/testgraph.001.dot")
	r1 := g1.GetEdgesSize()
	if r1 != 30 {
...
func Test_DOT_FindVertexByID(t *testing.T) {
	g1 := FromDOT("../../files/testgraph.001.dot")
...
func Test_DOT_CreateAndAddToGraph(t *testing.T) {
	g := FromDOT("../../files/testgraph.001.dot")
...
func Test_DOT_ImmediateDominate(t *testing.T) {
	testCases2 := []struct {
		vts []string
		imd bool
	}{
...
func Test_DOT_UpdateWeight(t *testing.T) {
	g := FromDOT("../../files/testgraph.001.dot")
	testCases := []struct {
		vertices []string
		weight   float64
...
func Test_DOT_DeleteVertex(t *testing.T) {
	testCases1 := []struct {
		vts    []string
		edgnum int
	}{
...
func Test_DOT_DeleteEdge(t *testing.T) {
	g := NewGraph()
	...
	g.DeleteEdge(a, c)
	if g.GetEdgesSize() != 2 {
		t.Error("Should only have 2 edges:", g.GetEdgesSize())
	}

	g.DeleteEdge(b, c)
	if g.GetEdgesSize() != 1 {
		t.Error("Should only have 1 edges:", g.GetEdgesSize())
	}

	g.DeleteEdge(a, b)
	if g.GetEdgesSize() != 0 {
		t.Error("Should only have 0 edge:", g.GetEdgesSize())
	}
