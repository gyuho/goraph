...
func TestFromJSON01(t *testing.T) {
	...
	if data.GetVertexSize() != 8 {
		t.Errorf("Expected 8 but %v", data.GetVertexSize())
	}
	for _, elem := range testgraph.Graph01 {
		weight1 := data.GetEdgeWeight(data.FindVertexByID(elem.Vertices[0]), data.FindVertexByID(elem.Vertices[1]))
		weight2 := elem.Weight
		if weight1 != weight2 {
...
func TestFromJSON05(t *testing.T) {
	...
	if data.GetVertexSize() != 6 {
		t.Errorf("Expected 6 but %v", data.GetVertexSize())
	}
...
func TestFromJSON12(t *testing.T) {
	...
	if data.GetVertexSize() != 5 {
		t.Errorf("Expected 5 but %v", data.GetVertexSize())
	}
...
func TestFromJSON14(t *testing.T) {
	...
	if data.GetVertexSize() != 9 {
		t.Errorf("Expected 9 but %v", data.GetVertexSize())
	}
...
func TestFromJSON16(t *testing.T) {
	...
	if data.GetVertexSize() != 10 {
		t.Errorf("Expected 10 but %v", data.GetVertexSize())
	}
