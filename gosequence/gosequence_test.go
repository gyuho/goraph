...
func main() {
	// We can use one Sequence type for both stack and queue.

	// Queue = FIFO (First-In-First-Out)
	queue := gosequence.NewSequence()
	fmt.Println(reflect.TypeOf(queue)) // *gosequence.Sequence
	...
	fmt.Println(queue.Len())      // 3
	fmt.Println(queue.Front())    // A
	fmt.Println(queue.PopFront()) // A
	fmt.Println(queue.Len())      // 2
	// to print out all elements in queue
	for queue.Len() != 0 {
		fmt.Print(queue.PopFront(), ",")
	}
	// 1,Hello,
	...
	stack := gosequence.NewSequence()
	fmt.Println(reflect.TypeOf(stack)) // *gosequence.Sequence
	...
	fmt.Println(stack.Back())     // Hello
	fmt.Println(stack.PopFront()) // A
	fmt.Println(stack.Len())      // 2
	// to print out all elements in stack
	for stack.Len() != 0 {
		fmt.Print(stack.PopFront(), ",")
	}
	// 1,Hello,
}
...
func main() {
	...
	fmt.Println(gosequence.SortMapSIByValue(sm1))
	// [{Hello -100} {California -10} {San Francisco 2} {New York 14} {Japan 15} {Los Angeles 23} {USA 30} {Korea 30} {Ohio 56} {Mountain View 70}]

	println()

	sm2 := map[string]float64{
		"California":    9.9,
		"Japan":         7.23,
		"Korea":         -.3,
		"Hello":         1.5,
	...
	fmt.Println(gosequence.SortMapSFByValue(sm2))
	// [{Ohio -1.1} {Korea -0.3} {New York 1.23} {Hello 1.5} {Japan 7.23} {USA 8.4} {San Francisco 8.4} {California 9.9} {Mountain View 9.9} {Los Angeles 23.1}]
}
*/
