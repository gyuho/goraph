`goraph` is a pure Go library for graph data structure. This is not for production, rather as a reference and practice. This has some good complicated examples on pointers and many other data structures in Go. For graph APIs, I highly recommend <a href="http://google-opensource.blogspot.co.uk/2014/06/cayley-graphs-in-go.html" target="_blank">Cayley</a>.
